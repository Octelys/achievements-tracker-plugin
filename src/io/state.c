...
#define GAMERSCORE_CONFIGURATION_SHADOW_ENABLED "source_gamerscore_shadow_enabled"
...
/* Stored as int: 0 = not set (default: enabled), 1 = enabled, 2 = disabled. */
#define GAMERTAG_CONFIGURATION_SHADOW_ENABLED "source_gamertag_shadow_enabled"
...
/* Stored as int: 0 = not set (default: enabled), 1 = enabled, 2 = disabled. */
#define GAME_NAME_CONFIGURATION_SHADOW_ENABLED "source_game_name_shadow_enabled"
...
/* Stored as int: 0 = not set (default: enabled), 1 = enabled, 2 = disabled. */
#define ACHIEVEMENT_NAME_CONFIGURATION_SHADOW_ENABLED "source_achievement_name_shadow_enabled"
...
/* Stored as int: 0 = not set (default: enabled), 1 = enabled, 2 = disabled. */
#define ACHIEVEMENT_DESCRIPTION_CONFIGURATION_SHADOW_ENABLED "source_achievement_description_shadow_enabled"
...
/* Stored as int: 0 = not set (default: enabled), 1 = enabled, 2 = disabled. */
#define ACHIEVEMENTS_COUNT_CONFIGURATION_SHADOW_ENABLED "source_achievements_count_shadow_enabled"
...
/* Global auto-visibility durations shared by all sources. */
...
void state_set_gamerscore_configuration(const gamerscore_configuration_t *gamerscore_configuration) {
    ...
    obs_data_set_int(g_state,
                     GAMERSCORE_CONFIGURATION_SHADOW_ENABLED,
                     gamerscore_configuration->shadow_enabled ? 1 : 2);
...
gamerscore_configuration_t *state_get_gamerscore_configuration() {
    ...
    bool        auto_visibility_enabled = obs_data_get_bool(g_state, GAMERSCORE_CONFIGURATION_AUTO_VISIBILITY_ENABLED);
    ...
    gamerscore_configuration->shadow_enabled =
        (int)obs_data_get_int(g_state, GAMERSCORE_CONFIGURATION_SHADOW_ENABLED) != 2;
...
void state_set_gamertag_configuration(const gamertag_configuration_t *configuration) {
    ...
    obs_data_set_int(g_state, GAMERTAG_CONFIGURATION_SHADOW_ENABLED, configuration->shadow_enabled ? 1 : 2);
...
gamertag_configuration_t *state_get_gamertag_configuration() {
    ...
    configuration->shadow_enabled          = (int)obs_data_get_int(g_state, GAMERTAG_CONFIGURATION_SHADOW_ENABLED) != 2;
...
void state_set_game_name_configuration(const game_name_configuration_t *configuration) {
    ...
    obs_data_set_int(g_state, GAME_NAME_CONFIGURATION_SHADOW_ENABLED, configuration->shadow_enabled ? 1 : 2);
...
game_name_configuration_t *state_get_game_name_configuration() {
    ...
    configuration->shadow_enabled = (int)obs_data_get_int(g_state, GAME_NAME_CONFIGURATION_SHADOW_ENABLED) != 2;
    configuration->top_color      = top_color == 0 ? 0xFFFFFFFF : top_color;
    configuration->bottom_color   = bottom_color == 0 ? 0xFFFFFFFF : bottom_color;
    configuration->font_size      = size == 0 ? 48 : size;
    configuration->font_face      = dup_font_face(font_face);
...
void state_set_achievement_name_configuration(const achievement_name_configuration_t *configuration) {
    ...
    obs_data_set_int(g_state, ACHIEVEMENT_NAME_CONFIGURATION_SHADOW_ENABLED, configuration->shadow_enabled ? 1 : 2);
    obs_data_set_bool(g_state,
...
achievement_name_configuration_t *state_get_achievement_name_configuration() {
    ...
    bool  auto_visibility_enabled = obs_data_get_bool(g_state, ACHIEVEMENT_NAME_CONFIGURATION_AUTO_VISIBILITY_ENABLED);
    float auto_visibility_show_duration =
    ...
    configuration->shadow_enabled = (int)obs_data_get_int(g_state, ACHIEVEMENT_NAME_CONFIGURATION_SHADOW_ENABLED) != 2;
...
void state_set_achievement_description_configuration(const achievement_description_configuration_t *configuration) {
    ...
    obs_data_set_int(g_state,
                     ACHIEVEMENT_DESCRIPTION_CONFIGURATION_SHADOW_ENABLED,
                     configuration->shadow_enabled ? 1 : 2);
    obs_data_set_bool(g_state,
...
achievement_description_configuration_t *state_get_achievement_description_configuration() {
    ...
    configuration->shadow_enabled =
        (int)obs_data_get_int(g_state, ACHIEVEMENT_DESCRIPTION_CONFIGURATION_SHADOW_ENABLED) != 2;
    configuration->active_top_color              = active_top_color == 0 ? 0xFFFFFFFF : active_top_color;
    configuration->active_bottom_color           = active_bottom_color == 0 ? 0xFFFFFFFF : active_bottom_color;
    configuration->inactive_top_color            = inactive_top_color == 0 ? 0x7F7F7FFF : inactive_top_color;
    configuration->inactive_bottom_color         = inactive_bottom_color == 0 ? 0x7F7F7FFF : inactive_bottom_color;
...
void state_set_achievements_count_configuration(const achievements_count_configuration_t *configuration) {
    ...
    obs_data_set_int(g_state, ACHIEVEMENTS_COUNT_CONFIGURATION_SHADOW_ENABLED, configuration->shadow_enabled ? 1 : 2);
    obs_data_set_bool(g_state,
...
achievements_count_configuration_t *state_get_achievements_count_configuration() {
    ...
    bool auto_visibility_enabled = obs_data_get_bool(g_state, ACHIEVEMENTS_COUNT_CONFIGURATION_AUTO_VISIBILITY_ENABLED);
    float auto_visibility_show_duration =
    ...
    configuration->shadow_enabled = (int)obs_data_get_int(g_state, ACHIEVEMENTS_COUNT_CONFIGURATION_SHADOW_ENABLED) !=
                                    2;
    configuration->top_color                     = top_color == 0 ? 0xFFFFFFFF : top_color;
    configuration->bottom_color                  = bottom_color == 0 ? 0xFFFFFFFF : bottom_color;
    configuration->font_size                     = size == 0 ? 48 : size;
...
void state_set_auto_visibility_durations(const auto_visibility_durations_t *durations) {
    ...
    obs_data_set_double(g_state, AUTO_VISIBILITY_SHARED_SHOW_DURATION, durations->show_duration);
    obs_data_set_double(g_state, AUTO_VISIBILITY_SHARED_HIDE_DURATION, durations->hide_duration);
    obs_data_set_double(g_state, AUTO_VISIBILITY_SHARED_FADE_DURATION, durations->fade_duration);
...
auto_visibility_durations_t *state_get_auto_visibility_durations(void) {
    ...
    float show = (float)obs_data_get_double(g_state, AUTO_VISIBILITY_SHARED_SHOW_DURATION);
    float hide = (float)obs_data_get_double(g_state, AUTO_VISIBILITY_SHARED_HIDE_DURATION);
    float fade = (float)obs_data_get_double(g_state, AUTO_VISIBILITY_SHARED_FADE_DURATION);

    auto_visibility_durations_t *d = bzalloc(sizeof(auto_visibility_durations_t));

    d->show_duration = show > 0.0f ? show : AUTO_VISIBILITY_DEFAULT_SHARED_SHOW_DURATION;
    d->hide_duration = hide > 0.0f ? hide : AUTO_VISIBILITY_DEFAULT_SHARED_HIDE_DURATION;
    d->fade_duration = fade > 0.0f ? fade : AUTO_VISIBILITY_DEFAULT_SHARED_FADE_DURATION;
